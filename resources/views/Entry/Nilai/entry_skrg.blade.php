...
@section('konten')
    ...
    <div class="content container-fluid">
        ...
        <!-- /Page Header -->
        <form method="POST" action="{{ route('entnilai.store') }}">
            @csrf
            <!-- Search Filter -->
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, v) {
                        html +=
                            ...
                            '<td><input type="text" class="form-control form-control-sm" name="nilai[]"></td>' +
                            '</tr>';
                    });
